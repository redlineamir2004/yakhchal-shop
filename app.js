...
/* ============ Telegram linking ============ */
$("telegram-link-btn").addEventListener("click", async () => {
  try {
    ...
    $("telegram-link-code-text").innerHTML =
      `کد شما: <b style="color:var(--accent); font-size:16px;">${code}</b><br>این کد رو ظرف ۱۰ دقیقه توی چت ربات تلگرام بفرستید.`;
  } catch (e) {
    toast("خطا در ساخت کد اتصال");
    console.error(e);
  }
});
